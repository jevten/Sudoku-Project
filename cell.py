...
class Cell(SudokuGenerator):
    ...
    def draw_sketched_value(self):
        ...
        displayed_value_rect = displayed_sketch_value.get_rect(center=(self.col * self.CELL_SIZE_VERT + self.CELL_SIZE_VERT // 2,self.row * self.CELL_SIZE_HORZ + self.CELL_SIZE_HORZ // 2))
        self.screen.blit(displayed_value, displayed_value_rect)
